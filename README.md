...
- **即時 3D 場景**：CIT 看台——弧形階梯看台（每四排一道 LED 燈條）、懸挑屋頂與桁架、屋頂上蓋著琉璃瓦頂的記者樓、看台後方的玻璃辦公空間（每扇窗都是程式生成的貼圖）、白色欄杆、兩座照明燈塔、後方的捷運高架與定時通過的列車、一排高樓、霓虹門、燈柱、珊瑚色月亮、有燈火的天際線、雨、霧、數據光點、航空警示燈。
