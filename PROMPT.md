...
- Work: three live scene windows as case cards plus a ruled list of the public cases with verifiable numbers.
- Services: five services as an atlas of plates (who it is for, what you get) and the three engagement models.
- Creative engine: a 5-angle × 3-version production matrix that lights up cell by cell, the CPA/ROAS figures, five priced tiers, a six-step process.
